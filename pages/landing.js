...
export default function LandingPage() {
  const handleStartSession = () => {
    console.log('Navigate to coaching session');
  };
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 md:py-32">
          <div className="text-center">
            ...
            <button
              ...
              className="inline-flex items-center px-12 py-4 text-lg font-medium text-white bg-black rounded-full hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] mb-24"
            >
              Start Session
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-lg font-medium text-black mb-1 tracking-wide">
                    {stat.label}
                  </div>
      ...
      <section className="py-24 bg-black text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <button
            onClick={handleStartSession}
            className="inline-flex items-center px-12 py-4 text-lg font-medium text-black bg-white rounded-full hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] mb-12"
          >
            Start Free Session
            <svg className="ml-3 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
